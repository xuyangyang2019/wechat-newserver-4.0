...
@Service
@Slf4j
public class CircleCommentNoticeHandler  implements MessageHandler{
	...
	public void handleMsg(ChannelHandlerContext ctx, TransportMessage vo) {
		try {
			...
			// 把消息转发给pc端
			asyncTaskService.msgSend2pc(req.getWeChatId(), EnumMsgType.CircleCommentNotice, req);
			
			//评论数据保存
			asyncTaskService.circleCommentSave(req);
