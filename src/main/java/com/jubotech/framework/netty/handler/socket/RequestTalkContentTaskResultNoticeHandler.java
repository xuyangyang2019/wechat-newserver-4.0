...
@Service
@Slf4j
public class RequestTalkContentTaskResultNoticeHandler  implements MessageHandler{
    ...
    public  void handleMsg(ChannelHandlerContext ctx, TransportMessage vo) {
        try {
			...
			asyncTaskService.msgSend2pc(req.getWeChatId(), EnumMsgType.RequestTalkContentTaskResultNotice, req);
