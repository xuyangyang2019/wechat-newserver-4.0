...
import Jubo.JuLiao.IM.Wx.Proto.ModifyFriendMemoTask.ModifyFriendMemoTaskMessage;
...
public class ModifyFriendMemoTaskWebsocketHandler implements JsonMessageHandler{
    ...
    public  void handleMsg(ChannelHandlerContext ctx,TransportMessage vo, String contentJsonStr) {
        try {
        	...
        	//将消息转发送给手机客户端
        	asyncTaskService.msgSend2Phone(ctx, req.getWeChatId(), EnumMsgType.ModifyFriendMemoTask, vo, req);
        } catch (Exception e) {
            e.printStackTrace();
