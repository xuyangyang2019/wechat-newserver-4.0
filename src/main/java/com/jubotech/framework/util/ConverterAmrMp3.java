...
public class ConverterAmrMp3 {
	 ...
	 * @param amrfilePath
	 */
	public static void amrToMp3(String coderPath, String amrfilePath) {
	 ...
	 * @param mp3filePath
	 */
	public static void mp3ToAmr(String coderPath, String mp3filePath) {
		if(StringUtils.isBlank(coderPath)){
			coderPath = silkv3Path;
		}
	...
	public static void main(String[] args) {
		...
		amrToMp3(coderPath, mp3filePath);
		mp3ToAmr(coderPath, amrfilePath);
	}
